...
import PatientFormAgeGen from "../components/Forms/PatientFormAgeGen";
        ...
        <div className="symp-checker w-100">
          <div className="content-container">
            ...
            <div className="symp-checker-steps">
              ...
              <h5>
                LƯU Ý: Kết quả chỉ mang tính chất tham khảo. Để tìm hiểu chính
                xác nhất về tình trạng của bản thân, vui lòng đến các cơ sở y tế
                hoặc đặt lịch khám tại bệnh viện chúng tôi để được chẩn đoán
                chính xác nhất.
              </h5>
            </div>
