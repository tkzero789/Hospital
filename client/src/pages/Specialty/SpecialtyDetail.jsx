...
import Pediatricians from "assets/img/pediatricians.jpg";
import Diabetes from "assets/img/diabetes.jpg";
import WomenCare from "assets/img/women-care.jpg";
import FamilyMedicine from "assets/img/family-medicine.jpg";
        ...
        <div className="c-9 md-12">
          ...
          <div className="specialty__detail">
            ...
            <div className="specialty__detail-img">
              <img src={specialty.img} alt="specialty care services" />
            </div>
          </div>
